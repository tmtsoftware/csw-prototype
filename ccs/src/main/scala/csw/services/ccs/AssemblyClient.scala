...
import csw.services.ccs.AssemblyController3._
import csw.services.ccs.CommandStatus2.{CommandResponse, Invalid, Accepted}
import csw.util.config.Configurations3.Setup
...
/**
  ...
  */
case class AssemblyClient2(assemblyController: ActorRef)(implicit val timeout: Timeout, context: ActorRefFactory) {
...
/**
  ...
  */
case class BlockingAssemblyClient2(client: AssemblyClient2)(implicit val timeout: Timeout, context: ActorRefFactory) {
