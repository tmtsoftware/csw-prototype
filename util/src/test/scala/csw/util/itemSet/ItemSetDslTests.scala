...
import csw.util.itemSet.UnitsOfMeasure.{NoUnits, degrees}
 ...
 */
class ItemSetDslTests extends FunSpec with Matchers {
...
//  private val ck3: String = "wfos.red.detector"
  ...
  describe("creating items") {
    import csw.util.itemSet.ItemSetDsl.{size => ssize}
  ...
  describe("checking simple values") {
    import csw.util.itemSet.ItemSetDsl.{value => svalue}
    val k1 = IntKey(s1)
