...
public class Algorithms {
   ...
   */
  public static boolean verifyZenithAngle(DoubleItem zenithAngle) { return zenithAngle.head() < 90.0 && zenithAngle.head() >= 0.0; }
  ...
  public  static boolean verifyFocusError(TromboneCalculationConfig calculationConfig, DoubleItem focusError) {
    return focusError.head() >= calculationConfig.lowerFocusLimit && focusError.head() <= calculationConfig.upperFocusLimit;
  }

  public static double zenithAngleToRangeDistance(double elevation, double zenithAngle) { return elevation / Math.cos(Math.toRadians(zenithAngle));}

  public static double rangeDistanceToElevation(double rangeDistance, double zenithAngle) { return Math.cos(Math.toRadians(zenithAngle)) * rangeDistance;}
   ...
   */
  public static double rangeDistanceToStagePosition(double rangeDistance) { return rangeDistance; }
