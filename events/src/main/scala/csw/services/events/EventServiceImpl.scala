...
import csw.services.events.EventService._
 ...
 */
case class EventServiceImpl[T: EventFormatter](host: String = "127.0.0.1", port: Int = 6379)(implicit _system: ActorRefFactory) extends EventService[T] {
