...
//
///**
//  * Supports Java subclasses of AssemblyController2 and LifecycleHandler
//  */
//abstract class AbstractAssemblyController2WithLifecycleHandler(override val info: AssemblyInfo) extends AbstractActor
