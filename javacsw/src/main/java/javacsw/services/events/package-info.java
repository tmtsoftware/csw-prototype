...
// * <p>
// * The {@link javacsw.services.events.IBlockingEventService} class provides factory methods to create
// * a key/value store for various event and config types. This API blocks while waiting for replies from
// * the server.
// * <p>
// * The {@link javacsw.services.events.IEventService} class also provides factory methods to create
