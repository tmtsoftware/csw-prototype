...
/**
 * Java admin API for the telemetry service.
 */
@SuppressWarnings("SameParameterValue")
public interface ITelemetryServiceAdmin {
  /**
   ...
   */
  static CompletableFuture<BoxedUnit> startTelemetryService(String name, Boolean noExit, ExecutionContext ec) {
    return JTelemetryServiceAdmin.startTelemetryService(name, noExit, ec);
  }
}
