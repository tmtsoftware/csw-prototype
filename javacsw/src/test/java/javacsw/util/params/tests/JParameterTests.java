...
public class JParameterTests {
  ...
  public void testBooleanItem() {
    ...
    BooleanParameter bi = jset(bk, bval);
    ...
    BooleanParameter bi2 = jset(bk, bval2).withUnits(JUnitsOfMeasure.degrees);
    ...
    BooleanParameter bi3 = jset(bk, true, false).withUnits(JUnitsOfMeasure.degrees);
  ...
  public void testByteArrayItem() {
    ...
    // Test singel item
    ByteArrayParameter di = jset(bk, ba1);
    ...
    ByteArrayParameter di2 = jset(bk, listIn).withUnits(JUnitsOfMeasure.degrees);
    ...
    // Test with varargs
    ByteArrayParameter di3 = jset(bk, ba1, ba2);
    ...
    ByteArrayParameter di4 = jset(bk, a, b, c).withUnits(JUnitsOfMeasure.meters);
  ...
  public void testByteMatrixItem() {
    ...
    ByteMatrixParameter di = jset(bk, bm1);
    ...
    // Test with list, withUnits
    ByteMatrixParameter di2 = jset(bk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    ByteMatrixParameter di3 = jset(bk, bm1, bm2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), bm2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    ByteMatrixParameter di4 = jset(bk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testCharItem() {
    ...
    // Test with list, withUnits
    CharParameter ci2 = jset(ck, listIn).withUnits(JUnitsOfMeasure.degrees);
  ...
  public void testDoubleKey() {
    ...
    // Test single item
    DoubleParameter di = jset(dk, dval);
    ...
    // Test with list, withUnits
    DoubleParameter di2 = jset(dk, dval2).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
  ...
  public void testDoubleArrayKey() {
    ...
    // Test single item
    DoubleArrayParameter di = jset(dk, da1);
    ...
    // Test with list, withUnits
    DoubleArrayParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test with var args
    DoubleArrayParameter di3 = jset(dk, da1, da2);
    ...
    DoubleArrayParameter di4 = jset(dk, a, b, c).withUnits(JUnitsOfMeasure.meters);
    assertEquals(jvalues(di4).size(), 3);
  ...
  public void testDoubleMatrixKey() {
    ...
    // Test with single item
    DoubleMatrixParameter di = jset(dk, dm1);
    ...
    DoubleMatrixParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test using varargs as matrix
    DoubleMatrixParameter di3 = jset(dk, dm1, dm2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), dm2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    DoubleMatrixParameter di4 = jset(dk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testFloatKey() {
    ...
    // Test single item
    FloatParameter fi = jset(fk, fval);
    ...
    FloatParameter fi2 = jset(fk, fval2).withUnits(JUnitsOfMeasure.degrees);
  ...
  public void testFloatArrayKey() {
    ...
    // Test single item
    FloatArrayParameter di = jset(fk, fa1);
    ...
    // Test list, withUnits
    FloatArrayParameter di2 = jset(fk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test with varargs
    FloatArrayParameter di3 = jset(fk, fa1, fa2);
    ...
    FloatArrayParameter di4 = jset(fk, a, b, c).withUnits(JUnitsOfMeasure.meters);
    assertEquals(jvalues(di4).size(), 3);
  ...
  public void testFloatMatrixKey() {
    ...
    // Test with single item
    FloatMatrixParameter di = jset(dk, fm1);
    ...
    FloatMatrixParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test using varargs as matrix
    FloatMatrixParameter di3 = jset(dk, fm1, fm2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), fm2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    FloatMatrixParameter di4 = jset(dk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testIntKey() {
    ...
    IntParameter ii2 = jset(ik, ival2, JUnitsOfMeasure.degrees);
  ...
  public void testStaticJavaIntItem() {
    ...
    IntParameter a = jset(encoder1, Arrays.asList(1, 2, 3));
  ...
  public void testIntArrayKey() {
    ...
    // Test single item
    IntArrayParameter di = jset(ak, ia1);
    ...
    // Test with list, withUnits
    IntArrayParameter di2 = jset(ak, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // test using var args
    IntArrayParameter ia3 = jset(ak, ia1, ia2);
    ...
    IntArrayParameter di4 = jset(ak, a, b, c).withUnits(JUnitsOfMeasure.meters);
  ...
  public void testIntMatrixKey() {
    ...
    // Test with single item
    IntMatrixParameter di = jset(dk, im1);
    ...
    IntMatrixParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test using varargs as matrix
    IntMatrixParameter di3 = jset(dk, im1, im2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), im2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    IntMatrixParameter di4 = jset(dk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testLongKey() {
    ...
    // Test with list, withUnits
    LongParameter li2 = jset(lk, lval2).withUnits(JUnitsOfMeasure.degrees);
  ...
  public void testLongArrayKey() {
    ...
    // Test single item
    LongArrayParameter di = jset(lk, la1);
    ...
    // Test with list, withUnits
    LongArrayParameter li2 = jset(lk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(li2.units(), JUnitsOfMeasure.degrees);
    ...
    // test using var args
    LongArrayParameter li3 = jset(lk, la1, la2);
    ...
    LongArrayParameter li4 = jset(lk, a, b, c).withUnits(JUnitsOfMeasure.meters);
  ...
  public void testLongMatrixKey() {
    ...
    // Test with single item
    LongMatrixParameter di = jset(dk, lm1);
    ...
    LongMatrixParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test using varargs as matrix
    LongMatrixParameter di3 = jset(dk, lm1, lm2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), lm2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    LongMatrixParameter di4 = jset(dk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testShortKey() {
    ...
    // Test single item
    ShortParameter si = jset(ik, sval);
    ...
    ShortParameter si2 = jset(ik, sval2).withUnits(JUnitsOfMeasure.degrees);
  ...
  public void testShortArrayKey() {
    ...
    // Test with single item
    ShortArrayParameter si = jset(sk, sa1);
    ...
    // Test with list, withUnits
    ShortArrayParameter si2 = jset(sk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(si2.units(), JUnitsOfMeasure.degrees);
    ...
    // Test with varargs
    ShortArrayParameter di3 = jset(sk, sa1, sa2);
    ...
    ShortArrayParameter di4 = jset(sk, a, b, c).withUnits(JUnitsOfMeasure.meters);
    assertTrue(jvalues(di4).size() == 3);
  ...
  public void testShortMatrixKey() {
    ...
    // Test with single item
    ShortMatrixParameter di = jset(dk, sm1);
    ...
    ShortMatrixParameter di2 = jset(dk, listIn).withUnits(JUnitsOfMeasure.degrees);
    assertSame(di2.units(), JUnitsOfMeasure.degrees);
    assertEquals(jvalue(di2, 1), listIn.get(1));
    assertEquals(jvalues(di2), listIn);
    ...
    // Test using varargs as matrix
    ShortMatrixParameter di3 = jset(dk, sm1, sm2).withUnits(JUnitsOfMeasure.seconds);
    assertSame(di3.units(), JUnitsOfMeasure.seconds);
    assertEquals(jvalue(di3, 1), sm2);
    assertEquals(jvalues(di3), listIn);

    // Test using varargs as arrays
    ShortMatrixParameter di4 = jset(dk, m1, m2).withUnits(JUnitsOfMeasure.meters);
    assertSame(di4.units(), JUnitsOfMeasure.meters);
  ...
  public void testStringKey() {
    ...
    // Test single item
    StringParameter si = jset(filter1, "A");
    ...
    // Test with varargs
    StringParameter b = jset(filter1, "100", "200");
    assertEquals(jvalues(b), Arrays.asList("100", "200"));
  }
  ...
  public void testChoiceItem() {
    // should allow creating with Choices object
    {
      ...
      ChoiceParameter ci = jset(ci1, Choice("A"));
    ...
    // should allow creating with varargs of Strings
    {
      ...
      ChoiceParameter ci = jset(ci2, Choice("A"));
      assertEquals(jvalue(ci), Choice("A"));
      // Check that non-choice fails
    ...
    // should allow creation with individual Choice items
    {
      ...
      // setting values
      ChoiceParameter ci = jset(cmd, ready);
  ...
  public void testingStructItem() {
    ...
    StructParameter citem = jset(skey, sc1);
