...
import akka.actor._
import csw.services.cmd_old.akka.CommandQueueActor.SubmitWithRunId
import csw.services.cmd_old.akka.CommandServiceActor.QueueBypassRequestWithRunId
import csw.services.cmd_old.akka.CommandStatusActor.StatusUpdate
import csw.services.cmd_old.akka.ConfigActor.{ ConfigResponse, ConfigGet }
...
case class LifecycleManager(componentProps: Props, regInfo: RegInfo, services: List[ServiceId])
  ...
  import csw.services.pkg_old.LifecycleManager._
